...
class MainWindow(QMainWindow):
    ...
    def export_ad26_script(self, path: str) -> None:
        ...
        lines = [
            ...
            "{ Run this procedure with the target footprint active in an Altium Designer 26 PCB Library. }",
            ...
            "    Begin",
            "        ShowMessage('No active footprint was found. Create or select a footprint in the PCB Library panel first.');",
            "        Exit;",
            "    End;",
            "",
        ...
        for pad in pads:
            ...
            lines.extend(
                [
                    ...
                    "            Component.I_ObjectAddress, c_Broadcast, PCBM_BoardRegisteration, Pad.I_ObjectAddress",
                    "        );",
                    "",
                ]
            )
        lines.extend(
            [
                ...
                "    ShowMessage('Pads added to the active footprint. If pad numbers are hidden, enable View Configuration > Additional Options > Pad Numbers.');",
                "End;",
                "",
                "{ PAD_TABLE_CSV",
